...
if (!$connectionError && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $errorMessage = "Databasefout bij het inloggen.";
    }
}

// Sensor data ophalen als ingelogd
if (!$connectionError && isset($_SESSION['username'])) {
    try {
        ...
        // Geen actie nodig hier, gewoon niets tonen
    }
}
?>
...
<?php elseif (isset($_SESSION['username'])): ?>
    ...
    <?php
        $imagePath = 'uploads/droomauto.png';
